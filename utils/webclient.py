"""
This file will be used to replace the webclient.py in the scrapy lib location.
Go to virtualenvs/created-environment/lib/python3.6/site-packages/scrapy/core/downloader/webclient.py and replace with that.
"""
